...
{
    ((GLViewFonts*)ManagerGLView::getGLView())->movePlayer(ptranslation, protation, ltranslation, lrotation, false);
    ((GLViewFonts*)ManagerGLView::getGLView())->setLabel(usermsg);
